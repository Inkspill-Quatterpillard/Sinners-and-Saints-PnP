...
Kostenbeispiel: 0,5 MP = Unterbindung eines Zaubertricks
 
1 MP = Störung eines einzelnen Zaubers oder Rituals

 
3 MP = Störung aller gesprochenen und aktiven Zauber in einem kleinen Radius

 
5 MP = Antimagische Zone in einem größerer Raum, die das Wirken jedweder Zauber stark einschränkt
...
Kostenbeispiel: 0,5 MP = Offensichtliche aktive Magie bei einem Objekt in Kontaktreichweite erspüren
 
1 MP = Objekt auf magische Spuren untersuchen
 
3 MP = Raum nach magischen Spuren durchsuchen
 
5 MP = Bestimmtes magisches Objekt in einer größeren Reichweite ausfindig machen
...
Kostenbeispiel: 0,5 MP = Analyse einer kleinen, einfachen Glyphe
 
1 MP = Analyse einer einzelnen Struktur, etwa einer Glyphe oder einer magischen Waffe
 
3 MP = Analyse eines Geflechts aus Runen
 
5 MP = Analyse eines komplexen magischen Mechanismus, etwa eines magischen Raums
...
Der Magier trennt seine Aura vom Körper. Er kann sich in einer Art arkanen Körper frei bewegen. Diese arkane Form ist für andere Lebewesen durch nichtmagische Mittel unsichtbar. Im Gegenzug kann der Magier durch seine Aura Magie- und Energieströme wahrnehmen. So kann der Magier etwa fremdes Gebiet auskundschaften, Lebewesen aufspüren oder sogar Gegner durch Magie hinterrücks angreifen.
 
Kostenbeispiel: Der Zauber kostet 1 MP für alle 10 Minuten, die die Aura vom Körper getrennt ist, sowie 1 MP zum Trennen des Körpers. Jede Meile, die sich der Magier von seinem Körper entfernt, kostet einen zusätzlichen MP.
...
Kostenbeispiel: 0,5 MP = Leichte Verbindung, die ein unterschwelliges Gefühl der Nähe hervorrufen kann

 
1 MP = Simple Verbindung, die zwei Lebewesen dieselbe Bezauberung für eine kurze Zeit teilen lässt

 
3 MP = Stabile Verbindung, mit der sich eine Einflussnahme von einem Lebewesen auf ein weiteres erstrecken lassen kann
 
5 MP = Starke Verbindung, die es Lebewesen ermöglicht, Schaden aller Art zu teilen (oder auch teilen zu müssen)
...
Kostenbeispiel: 0,5 MP = Obst auf einer Schale schweben lassen
 
1 MP = Schwerkraft auf dem Boden unter einer Person verstärken
 
3 MP = Gravitation in einer Fallgrube umkehren
 
5 MP = Schwerkraft in einem Raum aufheben
...
Kostenbeispiel: 0,5 MP = Farbe eines magischen Lichtes ändern
 
1 MP = Gelenkten Energieball übernehmen / Fallen-Glyphe entschärfen
 
3 MP = Seelenstein so modifizieren, dass er Energie entzieht anstelle abzugeben
 
5 MP = Ziel eines angreifenden Golems verändern
...
Kostenbeispiel: 0,5 MP = Kleines Loch in der Wand erkunden
 
1 MP = Entfernung zwischen zwei Punkten messen
 
3 MP = Kleines Objekt in einem Raum lokalisieren
 
5 MP = Abschnitt eines Höhlensystems erfassen
...
Kostenbeispiel: 0,5 MP = Vorrübergehendes Altersmakel auf einer fremden Hand
 
1 MP = Leben aus einem Lebewesen aussaugen
 
3 MP = Gesicht für eine kurze Zeitspanne jünger erscheinen lassen
 
5 MP = Lebewesen um Jahre altern lassen
 
10 MP = Leiche zu einem Untoten erheben
 
30+ MP = Kürzlich gestorbene Person wiederbeleben
...
Kostenbeispiel: 0,5 MP = Papierkugel teleportieren
 
1 MP = Kleinen Gegenstand in direkter Reichweite teleportieren, zum Beispiel einen Geldbeutel
 
3 MP = Raumsprung (Direkte Sichtlinie überqueren)
 
5 MP = Eigene Teleportation im Bereich der Aura / Öffnung eines Portals über kurze Reichweite (Umkreis von 3 Meilen) / Teleportation eines kleinen Gegenstand über größere Entfernung
 
10 MP = Öffnung eines Portals über mittlere Reichweite (Umkreis von 10 Meilen)
 
20 MP = Öffnung eines Portals über große Reichweite (Umkreis von 50 Meilen)
 
50 MP = Öffnung eines Portals in einer riesigen Reichweite (Umkreis von 500 Meilen)
...
Kostenbeispiel: 0,5 MP = Münze langsamer fallen lassen
 
1 MP = Pfeil verschnellern
 
3 MP = Kurzen Blick in die unmittelbare Zukunft werfen
 
5 MP = Zeit für eine kurze Periode verlangsamen
